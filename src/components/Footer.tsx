              ...
              {section.title !== "Social" ? (
                ...
                <>
                  <div key={section.title} className="space-y-4">
                    ...
                    <div className="flex gap-6 ml-[50px] md:ml-[0px] md:flex-wrap">
                      {socialLinks.map((social, index) => (
                        <a
                          ...
                          className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-black hover:bg-white/20 transition-all duration-300"
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400">
              © 2026 AnirudhMusic. All rights reserved.
            </p>
